...
export default function BoqApprovalsPanel() {
    ...
    return (
        <div className="w-full">
            <Card className="shadow-none border-0">
                <CardHeader className="bg-muted/50 border-b flex flex-row items-center justify-between px-0 sm:px-2">
                    <div>
                        <CardTitle className="text-xl">BOQ Approvals</CardTitle>
